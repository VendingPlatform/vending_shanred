...
public class FirmInfo implements Serializable {
	...
	public Integer getHasTry() {
		return hasTry;
	}

	public void setHasTry(Integer hasTry) {
		this.hasTry = hasTry;
	}
	...
	public String toString() {
		return "{" + "\"firmId\":\"" + firmId + "\"," + "\"firmName\":\"" + firmName + "\"," + "\"firmDesc\":\""
				+ firmDesc + "\"," + "\"firmType\":\"" + firmType + "\"," + "\"hasTry\":\"" + hasTry + "\","
				+ "\"startTime\":\"" + startTime + "\"," + "\"endTime\":\"" + endTime + "\"," + "\"machineNum\":\""
				+ machineNum + "\"," + "\"firmStatus\":\"" + firmStatus + "\"," + "\"operateId\":\"" + operateId + "\","
