                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<%=basePath%>updatePassWd!updatePassWd.action" class="form-horizontal margin-bottom-lg"  method="post" id="updatepasswdss">
...
<script src="<%=basePath%>/helpDeskUI/assets/js/pages/edit_passW.js"></script>
