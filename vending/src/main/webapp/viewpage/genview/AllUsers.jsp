		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="width: 80%; padding-left: 30px">
					...
					<input type="hidden" name="operateId" value="${user.userId }">
						<div class="form-group">
							<label for="userNo">用户编号:</label> <input type="text"
								class="form-control" name="userNo" placeholder="输入编号" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="mobilePhone">电话:</label> <input type="text"
								class="form-control" name="mobilePhone" placeholder="输入电话号码">
						</div>
						<div class="form-group">
							<label for="email">邮箱:</label> <input type="text"
								class="form-control" name="email" placeholder="输入邮箱">
						</div>
						<c:if test="${groupInfosToAsssign!=null }">
							<div class="form-group">
								<label for="groupId">分组:</label> <select name="groupId"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary"
						onclick="insertUser()" data-dismiss="modal">保存</button>
				</div>
			</div>
		</div>
	</div>
