			...
			<table class="table">
				...
				<c:forEach items="${machineOperaterInfo}" var="machine">
					<tr>
						...
						<td>
							<a href="#" class="btn default" ><span class="glyphicon glyphicon-info-sign" title="详情"></span></a>
							<a href="#" class="btn default"><span class="glyphicon glyphicon-edit" title="编辑"></span></a>
						</td>
					</tr>
				</c:forEach>
			</table>
