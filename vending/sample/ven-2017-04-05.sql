...
CREATE TABLE `roleinfo` (
  ...
  PRIMARY KEY (`roleId`),
  KEY `authId` (`authId`),
  CONSTRAINT `roleinfo_ibfk_1` FOREIGN KEY (`authId`) REFERENCES `authorityinfo` (`authId`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
...
insert  into `roleinfo`(`roleId`,`roleName`,`authId`,`status`,`firmId`,`operateId`,`operateDate`) values 
(1,'system',1,1,1,1,'2017-02-27 12:54:59'),
(2,'oper_admin',2,1,2,1,'2017-02-27 16:10:10'),
(3,'manu_admin',3,1,3,1,'2017-02-27 17:03:15'),
(4,'oper_admin',3,1,2,2,NULL);
